type PhotoSize =
  ...
  | "portrait"
  | "landscape";
type PhotoSizeMap = { [size in PhotoSize]: string };
...
namespace Response {
  export namespace Photo {
    ...
    export interface Retrieved extends Photo {}
  }
  ...
  export namespace Video {
    ...
    export interface Retrieved extends Video {}
  }
}
...
export type {
    CuratedPhotosParameters, PaginationParameters, Photo, PhotoSearchParameters, PhotoSize,
    PhotoSizeMap, PopularVideosParameters, Response, SearchParameters, User, Video, VideoFile,
    VideoPicture, VideoSearchParameters, RetrieveDataFromEndpoint
};
